                ...
                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 ">
                    <div class="col-md-4 col-sm-6" >
                        <div class="text-center">
                            ...
                            <p>
                                Vršimo punjenje ketridža za ink jet štampače po vodećim standardima sa najkvalitetnijim bojama 
                                po pristupačnim cenama uz mogoćnost dostave.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6"  >
                        <div class="text-center">
                            ...
                            <h4>Dopuna tonera</h4>
                            <p>
                               Vršimo reciklažu toner kaseta sa kvalitenim toner prahom iz čega proizilazi kvalitetnija štampa u 
                               odnosu na originalnu kasetu sa istim brojem kopija kao kod originalne toner kasete.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6" >
                        <div class="text-center">
                            ...
                            <p>
                                Servis obavlja stručno osoblje koje koristi potrošne kao i originalne delove da bi štampač
                                zadražao fabričke karakteristike.
                            </p>
                        </div>
                    </div>
 ...
 <div id="service-section">
    ...
    <div position= "center">
         <h3 class="media-heading">Letnja akcija je pri kraju.</h3>
              <p>Ostalo je jos malo vremena do isteka akcije, koja napominjemo traje do kraja avgusta, Za više informacija dođite do našeg servisa ili nas kontaktirajte putem E-mail adrese. <br/>
              <em>14.7.2016.</em></p>
    </div>
   <div>
         <h3 class="media-heading">Otvorena Letnja akcija !!!</h3>
              <p>Dragi kupci želimo da Vas obavestimo da počinje letnja akcija u našem servisu, Za više informacija dođite do našeg servisa ili nas kontaktirajte putem E-mail adrese. <br/>
                  <em>2.7.2016.</em></p>
    </div>
    <div><h3>Obaveštenje:</h3>
              <p>Uskoro će krenuti letnja akcija u našem servisu. Očekujemo Vas da će te doći. Za više informacija dođite do našeg servisa ili nas kontaktirajte putem E-mail adrese. <br/>
              <em>22.6.2016.</em></p>
    </div>
    <div>
         <h3 class="media-heading">Zašto nas odabrati?</h3>
              <p>Naš tim čine stručna lica koja koja se bave ovim poslom. Oni imaju više godina iskustva u ovom području. Oni će Vam pomoći da rešite Vaš problem. Za više informacija o našim uslugama dođite do našeg servisa ili nas kontaktirajte putem E-mail adrese. <br/>
              <em>14.6.2016.</em></p>
    </div>
   <div>
